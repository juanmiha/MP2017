...
/**
 * Clase de numeros aleatorios, usando un
...
public class NumerosAleatorios
{
    ...
    /**
     * Construccion de un objeto Random cuyo
    ...
    /**
     * Construccion de un objeto Random
    ...
    /**
     * Intercambia el valor del index1 por el valor del index2  y vicersa sin perdida del valor original.
     * @param a
     * @param index1
     * @param index2
     */
